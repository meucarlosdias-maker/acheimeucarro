...
begin
  ...
  values (p_nome, p_slug, p_email, p_user_id, p_cidade_id, p_telefone, p_whatsapp, p_endereco, p_cnpj, p_website, p_instagram, p_facebook, p_horario_funcionamento, p_descricao, 'pendente');
end;
$$;
